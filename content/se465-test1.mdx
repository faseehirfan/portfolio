...
$$
\langle \text{print_state}, q \rangle \Downarrow q
$$
...
1. Evaluate $ p := 0 $ in the empty state $ [] $:
   $$
   \langle 0, [] \rangle \Downarrow 0 \quad \langle p := 0, [] \rangle \Downarrow [p := 0]
   $$

2. Evaluate $ x := 1 $ in the state $ [p := 0] $:
   $$
   \langle 1, [p := 0] \rangle \Downarrow 1 \quad \langle x := 1, [p := 0] \rangle \Downarrow [p := 0, x := 1]
   $$

3. Evaluate $ n := 2 $ in the state $ [p := 0, x := 1] $:
   $$
   \langle 2, [p := 0, x := 1] \rangle \Downarrow 2 \quad \langle n := 2, [p := 0, x := 1] \rangle \Downarrow [p := 0, x := 1, n := 2]
   $$
